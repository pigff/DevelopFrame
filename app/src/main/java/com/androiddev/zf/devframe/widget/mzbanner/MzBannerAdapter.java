...
public class MzBannerAdapter extends RecyclerView.Adapter<MzBannerAdapter.MzViewHolder> {
    ...
    public MzBannerAdapter.MzViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MzViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_item_card_banner, parent, false));
    }
    ...
    class MzViewHolder extends RecyclerView.ViewHolder {
        ...
        MzViewHolder(View itemView) {
            super(itemView);
            imageView = (ImageView) itemView.findViewById(R.id.iv_card_banner);
        }
    }
